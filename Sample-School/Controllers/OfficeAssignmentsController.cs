...
namespace Sample_School.Controllers
{
    public class OfficeAssignmentsController : Controller
    {
        ...
        public OfficeAssignmentsController(Sample_SchoolDbContext context)
        {
            _context = context;
        }
        ...
        {
            var sample_SchoolDbContext = _context.OfficeAssignments.Include(o => o.Instructor);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Sample_SchoolDbContext.OfficeAssignments'  is null.");
            }
            var officeAssignment = await _context.OfficeAssignments.FindAsync(id);
            if (officeAssignment != null)
            {
