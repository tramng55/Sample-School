...
namespace Sample_School.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public DepartmentsController(Sample_SchoolDbContext context)
        {
            _context = context;
        }
        ...
        {
            var sample_SchoolDbContext = _context.Departments.Include(d => d.Administrator);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Sample_SchoolDbContext.Departments'  is null.");
            }
            var department = await _context.Departments.FindAsync(id);
            if (department != null)
            {
