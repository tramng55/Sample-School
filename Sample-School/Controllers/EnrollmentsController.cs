...
namespace Sample_School.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public EnrollmentsController(Sample_SchoolDbContext context)
        {
            _context = context;
        }
        ...
        {
            var sample_SchoolDbContext = _context.Enrollments.Include(e => e.Course).Include(e => e.Student);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Sample_SchoolDbContext.Enrollments'  is null.");
            }
            var enrollment = await _context.Enrollments.FindAsync(id);
            if (enrollment != null)
            {
