...
namespace Sample_School.Controllers
{
    public class CourseAssignmentsController : Controller
    {
        ...
        public CourseAssignmentsController(Sample_SchoolDbContext context)
        {
            _context = context;
        }
        ...
        {
            var sample_SchoolDbContext = _context.CourseAssignments.Include(c => c.Course).Include(c => c.Instructor);
            return View(await sample_SchoolDbContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Sample_SchoolDbContext.CourseAssignments'  is null.");
            }
            var courseAssignment = await _context.CourseAssignments.FindAsync(id);
            if (courseAssignment != null)
            {
